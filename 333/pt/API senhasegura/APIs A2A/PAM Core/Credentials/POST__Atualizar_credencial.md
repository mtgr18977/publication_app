...
<br><b>Possível causa</b>: sua autorização não possui permissão de alteração de credencial. 
...
<b>Solução</b>: informe um valor para o plugin de criação, remoção, ativação ou desativação da credencial. Esse plugin deve ser existente e estar cadastrado no senhasegura.
...
<b>Solução</b>: informe um valor para o template de criação, remoção, ativação ou desativação da credencial. Esse template deve ser existente e estar cadastrado no senhasegura.
