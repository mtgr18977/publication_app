...
Neste documento, você vai encontrar todas as informações sobre a tela **Ocorrências por usuário** que exibe um relatório com um ranking de sessões baseados nos comandos auditados, dispositivos-alvo, credenciais e contas senhasegura utilizadas.
