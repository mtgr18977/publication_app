...
* **Action:** in this column, you access:  
  * **Commands**: represented by the magnifying glass icon, it opens the **[Sessions with occurrences detected](/v3-33/docs/sessions-with-occurrences-detected)** screen.  
