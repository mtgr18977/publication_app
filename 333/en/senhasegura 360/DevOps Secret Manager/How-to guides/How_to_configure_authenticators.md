...
3. Provide the required data in case of a new application as mentioned in the [Application](/v3-33/docs/how-to-manage-an-application-in-devops-secret-manager) document.
4. Click **Save**.
