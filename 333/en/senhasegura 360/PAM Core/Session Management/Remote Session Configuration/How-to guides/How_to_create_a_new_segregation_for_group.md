...
* Previously create a global remote session setting. To know how to do this, access the [How to configure a remote session](/v3-33/docs/pam-session-configure-remote-session-proxy) document.
...
[How to create a new segregation for device](/v3-33/docs/pam-session-create-segregation-device)
