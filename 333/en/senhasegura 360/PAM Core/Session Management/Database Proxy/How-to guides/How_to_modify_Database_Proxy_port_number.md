...
* Be an admin user
* Start an SSH admin session into the vault. Access the [How to access a SSH admin session into the senhasegura platform](/v3-33/docs/administration-ssh-access) document to know how to perform this action.
...
[Database Proxy](/v3-33/docs/pam-session-about-database-proxy)
