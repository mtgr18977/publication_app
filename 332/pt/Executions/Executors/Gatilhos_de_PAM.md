...
| Desativação de credenciais | Desabilite uma credencial de destino após o uso do proxy senhasegura. Também pode ser usado para realizar uma destruição de credencial JIT |
...
| Gatilho | Descrição |
| --- | --- |
| AWS OpsWorks | Usado no DSM senhasegura para fornecer gerenciamento de credenciais e segredos no AWS OpsWorks |
