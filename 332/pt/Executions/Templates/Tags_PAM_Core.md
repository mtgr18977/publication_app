Tags são variáveis pré\-definidas que podem ser utilizadas em templates senhasegura ao invés de informações codificadas, permitindo o uso do mesmo template para operações em vários dispositivos.
