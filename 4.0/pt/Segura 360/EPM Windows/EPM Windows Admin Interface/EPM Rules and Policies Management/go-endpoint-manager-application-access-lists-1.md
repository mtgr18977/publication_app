...
Neste documento, você aprenderá como configurar listas de acessos de aplicações nos clients do PEDM EPM Windows, tanto para segregação geral (para todas as workstations), como para workstations específicas.

## Como configurar listas de acessos de aplicações para segregação geral
 
1. No Segura, acesse a página de **Listas de acesso** através do caminho: **Grid Menu** > **EPM** > **Políticas** >  **Windows** >  **Listas de acesso**.
...
8. Marque as opções para a **Configuração de elevação**:
	...
	* **Aprovação em níveis**: para funcionar, os aprovadores devem estar cadastrados em níveis no [Relatório de aprovadores](/v4/docs/pt/go-endpoint-manager-windows-approval-workflow-1).
...
:::(Info) (Info)
As regras serão aplicadas tanto para aplicações iniciadas nos agentes EPM quanto para aplicações iniciadas fora do EPM. Os valores das regras de segregação podem ser preenchidos com expressões regulares.
:::
