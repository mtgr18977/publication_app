...
# Referência para Parâmetros do EPM

Acesse a configuração de parâmetros do **PEDM EPM** através do caminho **Grid Menu** > **EPM** > **Configurações** > **Parâmetros** > **EPM**. Na tela, você encontrará as seguintes informações:

:::(Info) (Info)
O caminho indicado acima é exclusivo para o senhasegura v.3.32 e o agente do **PEDM EPM** para Windows v.3.32. Usuários de versões inferiores a essa devem acessar a configuração de parâmetros através do caminho **Grid Menu** > **EPM** > **Configurações** > **Parâmetros** > **EPM Windows**.
:::
