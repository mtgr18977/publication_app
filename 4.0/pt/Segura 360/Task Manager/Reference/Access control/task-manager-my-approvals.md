...
## Requisitos
* Ser um usuário aprovador em algum **Grupo de acesso**.


## Caminho para acessar
1. No Segura, no canto superior esquerdo, clique no **Grid Menu**, representado pelos nove quadrados, e selecione **Task Manager**.
...
- **Ação**: nessa coluna, você acessa as seguintes opções:
  ...
  - **Ícone dos três pontos verticais**: abre um menu suspenso com as opções **Reprovar** e **Detalhes**.
