...
:::(info) (**Info**)
By following the steps in this tutorial, permission will be given to **the whole group** of users inserted in the selected folder. To grant permission to **just one user**, access [How to change a domain user's password in AD](/v4/docs/executions-how-to-change-a-domain-users-password-in-ad) document.
:::
...
---
Do you still have questions? Reach out to the Segura community[https://community.senhasegura.io/](https://community.senhasegura.io/){target=`_blank`}.