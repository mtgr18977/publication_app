...
:::(info) (Info)
**Cloud IAM** also supports Amazon Web Services (AWS) and Microsoft Azure. If you want to integrate other CSPs, check the documentation [Connect an AWS account](/v4/docs/cloud-iam-connect-an-aws-account) or [Connect an Azure account](/v4/docs/cloud-iam-connect-an-azure-account).
:::

Before you integrate a GCP account with Segura, you’ll need a [Google Cloud Platform](https://cloud.google.com/) account.
...
3. Give your service account an easily identifiable name. You’ll be using this account to integrate with Segura.
...
Once you’re done, the Segura **Accounts** page will refresh with your newly integrated GCP account.