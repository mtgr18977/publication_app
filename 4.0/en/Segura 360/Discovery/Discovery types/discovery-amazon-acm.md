...
- Import all certificates automatically: all Amazon ACM certificates that are found will be imported into Segura.
- Export certificate key?: the keys of the Amazon ACM certificates found will be exported to Segura.
